...
from app.api.api_v1.endpoints import login, users, utils, commitmentcategory, commitment, transaction, reputation, transaction, updates
...
api_router.include_router(updates.router, prefix="/updates", tags=["update"])
